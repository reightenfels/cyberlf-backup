...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20250426_webbis_b0aaaf43cdede8f08726_20250426101123_archive.zip';
        const ARCHIVE_SIZE       = '81698377';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b0aaaf4-26101123';
        const SECONDARY_PACKAGE_HASH = '060d053-26101123';
